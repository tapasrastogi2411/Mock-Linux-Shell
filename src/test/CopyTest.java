...
public class CopyTest {
  ...
  /**
   * Copy variable so that we can test its methods
   */
  Copy cp;
  ...
  /**
   * Tree variable to check the file System structure after copy command is executed
   */
  Tree tree;
  ...
  public void testExecuteCommand(){
    ...
    String[] argument1 = {"cp", "/a", "/c"};
    cp.executeCommand(argument1);
