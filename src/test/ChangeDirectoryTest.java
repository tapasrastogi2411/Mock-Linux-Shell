...
public class ChangeDirectoryTest {
  ...
  /**
   * MakeDirectory object to use for testing the ChangeDirectory methods
   */

  MakeDirectory mkdir;

  /**
   * ChangeDirectory object to use for testing the ChangeDirectory methods
   */
  ChangeDirectory cd;
  ...
  public void testExecuteCommand() {
    ...
    cd.executeCommand("cd dir1");
    String expected = "/dir1";
    String actual = FileSystem.currentDirectory.getPath();
